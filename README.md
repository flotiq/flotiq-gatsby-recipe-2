...
1. **Start the project from template using [Flotiq CLI]((https://github.com/flotiq/flotiq-cli))**
   ...
   flotiq start [flotiqApiKey] [projectName] https://github.com/flotiq/flotiq-gatsby-recipe-2.git
    ```
...
5. **Open the source code and start editing!**
   ...
   Open the `flotiq-gatsby-recipe-2` directory in your code editor of choice and edit `src/templates/index.js`. Save your changes and the browser will update in real time!
